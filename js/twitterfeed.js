...
$(document).ready(function () {
	...
	var followaddres = "https://twitter.com/intent/follow?original_referer=&screen_name=ne4iporuk92&tw_p=followbutton&variant=2.0";
				...
				//console.log(feeds[i]);
				 ...
				 if (((showretweets == true) || ((isaretweet == false) && (showretweets == false))) && ((showdirecttweets == true) || ((showdirecttweets == false) && (isdirect == false)))) { 
					if ((feeds[i].text.length > 1) && (displayCounter <= displaylimit)) {             
						...
						feedHTML += ' <a href='+ followaddres +' target="_blank" class="twitter-follow-button btn btn-info" data-show-count="false" data-size="large" data-show-screen-name="false"><i class="icon-twitter"></i><i class="icon-plus3"></i></a>';										                 
